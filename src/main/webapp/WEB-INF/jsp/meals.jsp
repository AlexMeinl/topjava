...
<div class="jumbotron">
    ...
    <form method="post" action="meals/filter">
        ...
        <button class="btn btn-lg btn-primary" type="submit"><spring:message code="meals.filter"/></button>
    </form>
    <hr>
        <a class="btn btn-info" onclick="add()"><spring:message code="meals.add"/></a>
    <hr>
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                ...
                <td><a class="btn btn-warning" onclick="deleteRow(${meal.id})"></a></td>
            </tr>
        </c:forEach>
    </table>
    </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="dateTime" class="control-label col-xs-3"><th><spring:message code="meals.dateTime"/></label>
